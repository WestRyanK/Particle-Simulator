...
const float BodyParticleGenerator::CUBE_GRAIN_CORNER_RATIO = 0.25f;
...
std::vector<glm::vec3> BodyParticleGenerator::get_tetrahedron_grain_offsets(float base_particle_size)
{
	...
	tetrahedron_grain_offsets.push_back(glm::vec3(1.0f, 0.0f, -1.0f / glm::sqrt(2.0f)) * base_particle_size);
	tetrahedron_grain_offsets.push_back(glm::vec3(-1.0f, 0.0f, -1.0f / glm::sqrt(2.0f)) * base_particle_size);
	tetrahedron_grain_offsets.push_back(glm::vec3(0.0f, 1.0f, 1.0f / glm::sqrt(2.0f)) * base_particle_size);
	tetrahedron_grain_offsets.push_back(glm::vec3(0.0f, -1.0f, 1.0f / glm::sqrt(2.0f)) * base_particle_size);
...
{
	const float CORNER = 1.0f / glm::sqrt(2.0f);
	...
	cube_grain_offsets.push_back(glm::vec3(CORNER, CORNER, CORNER) * base_particle_size * (1.0f + CUBE_GRAIN_CORNER_RATIO));
	cube_grain_offsets.push_back(glm::vec3(CORNER, CORNER, -CORNER) * base_particle_size * (1.0f + CUBE_GRAIN_CORNER_RATIO));
	cube_grain_offsets.push_back(glm::vec3(-CORNER, CORNER, -CORNER) * base_particle_size * (1.0f + CUBE_GRAIN_CORNER_RATIO));
	cube_grain_offsets.push_back(glm::vec3(-CORNER, CORNER, CORNER) * base_particle_size * (1.0f + CUBE_GRAIN_CORNER_RATIO));
	cube_grain_offsets.push_back(glm::vec3(CORNER, -CORNER, CORNER) * base_particle_size * (1.0f + CUBE_GRAIN_CORNER_RATIO));
...
std::vector<float> BodyParticleGenerator::get_tetrahedron_grain_sizes(float base_particle_size)
{
	...
	tetrahedron_grain_sizes.push_back(base_particle_size);
	tetrahedron_grain_sizes.push_back(base_particle_size);
	tetrahedron_grain_sizes.push_back(base_particle_size);
	tetrahedron_grain_sizes.push_back(base_particle_size);
...
std::vector<float> BodyParticleGenerator::get_cube_grain_sizes(float base_particle_size)
{
	...
	cube_grain_sizes.push_back(base_particle_size * CUBE_GRAIN_CORNER_RATIO);
	cube_grain_sizes.push_back(base_particle_size * CUBE_GRAIN_CORNER_RATIO);
	cube_grain_sizes.push_back(base_particle_size * CUBE_GRAIN_CORNER_RATIO);
	cube_grain_sizes.push_back(base_particle_size * CUBE_GRAIN_CORNER_RATIO);
	cube_grain_sizes.push_back(base_particle_size * CUBE_GRAIN_CORNER_RATIO);
